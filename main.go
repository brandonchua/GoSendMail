...
func main() {
	...
	from := "hello@brandonchua.com"

	// Array of recipients address
	to := []string{"brandonchua@brandonchua.com"}

	// Create a message and convert it into bytes
	msg := []byte("To: brandonchua@brandonchua.com\r\n" +
		"From: hello@brandonchua.com\r\n" +
		"Subject: Hello Gophers!\r\n" +
		"\r\n" +
		"This is the email is sent using golang and send in blue.\r\n")
